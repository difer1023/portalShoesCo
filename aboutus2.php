            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active"><a href="#">Sobre nosotros <i class="fa fa-angle-down"></i></a>
            ...
            <div class="row">
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        ...
                        utilizando maquinaria de última generación para obtener un producto acorde a la preferencia actual del consumidor que cumple con las normas de calidad establecidas.
                        Nosotros estamos comprometidos con la satisfacción de nuestros clientes. Para lograrlo, propendemos hacia el mejoramiento continuo, la innovación en los productos,
                        la adaptación a los cambios y la evolución frente al entorno en que nos encontramos, para posicionarnos en el marco de la globalización.
                        </p>
                    </div>
                </div>
