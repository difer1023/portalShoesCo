                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active" tabindex="7"><a href="../../../componentes/sobrenosotros/vista/sobrenosotros.php">Sobre nosotros</a></li>
                            <li tabindex="8"><a href="../../../componentes/contacto/vista/contacto.php">Contacto</a></li>                          
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-6 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <div class="single-service">
                            <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                                <img src="../../../contenido/images/home/icon1.png" alt="Imagen alusiva a la misión de la empresa" tabindex="10">
                            </div>
                            <h2 tabindex="11">Misión</h2>
                            <p tabindex="12">Somos una compañía productora de calzado, que tiene como objetivo manufacturar un producto de óptima calidad, 
                    ...
                    <div class="col-sm-6 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="single-service">
                            <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="600ms">
                                <img src="../../../contenido/images/home/icon2.png" alt="Imagen alusiva a la visión de la empresa" tabindex="13">
                            </div>
                            <h2 tabindex="14">Visión</h2>
                            <p tabindex="15">Para el año 2020 nos consolidaremos como una de las compañías más reconocidas en la industria del 
